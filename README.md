...
- [metaory/jsonresume-theme-roundy](https://github.com/metaory/jsonresume-theme-roundy) - 🚧 WIP -- A modern and minimal JSONResume compatible theme with Astro
...
- [metaory/devtools-theme](https://github.com/metaory/devtools-theme) - DevTools theme for Chromium-based browsers
...
- [metaory/meta-vanilla-web-component](https://github.com/metaory/meta-vanilla-web-component) - Proof-of-concept micro framework built on Web Components with zero dependencies, demonstrating modern vanilla JS patterns
...
- [jsebrech/view-transition-element](https://github.com/jsebrech/view-transition-element) - Vanilla routing and view transitions example
- [metaory/invert-site](https://github.com/metaory/invert-site) - chrome extension that Toggle CSS invert on the current page
- [metaory/code-copy](https://github.com/metaory/code-copy) - Chrome extension - Copy text from code blocks and page elements to the clipboard on click
- [golanlevin/p5-single-line-font-resources](https://github.com/golanlevin/p5-single-line-font-resources) - An archive of monoline vector fonts, and p5.js code to render them.
- [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) - Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop
- [usebruno/bruno](https://github.com/usebruno/bruno) - Opensource IDE For Exploring and Testing API's (lightweight alternative to Postman/Insomnia)
- [brendan-duncan/webgpu_inspector](https://github.com/brendan-duncan/webgpu_inspector) - Inspection debugger for WebGPU
- [lo-th/phy](https://github.com/lo-th/phy) - Physics for three. Game engine
- [metaory/live-css-queries](https://github.com/metaory/live-css-queries) - Chrome extension - Evaluates CSS selectors on the active webpage and highlights matching elements in an on-page match panel
...
- [metaory/smart-value-toggle](https://github.com/metaory/smart-value-toggle) - vscode extension - Cycle or increment/decrement values on the current line: targets the value under the cursor or jumps to the first match
- [patriciogonzalezvivo/glslEditor](https://github.com/patriciogonzalezvivo/glslEditor) - Simple WebGL Fragment Shader Editor
- [metaory/json-diff-viewer-component](https://github.com/metaory/json-diff-viewer-component) - Compare JSON side-by-side, visually, Framework Agnostic Web Component
- [metaory/open-marketplace](https://github.com/metaory/open-marketplace) - 
...
- [metaory/glitcher-app](https://github.com/metaory/glitcher-app) - Turn text or images into animated glitches // SVG • WebM • GIF
...
- [metaory/symbol-logo-maker-experiment](https://github.com/metaory/symbol-logo-maker-experiment) - [WIP] A minimalist tool that transforms any symbol, character, or glyph into a professional logo with custom colors and background
...
- [metaory/shadertoy2webgl](https://github.com/metaory/shadertoy2webgl) - CLI and library to convert ShaderToy shaders to standalone WebGL2 applications with uniform handling and zero dependencies
- [metaory/noseyparker-compact](https://github.com/metaory/noseyparker-compact) - CLI tool to transform verbose noseyparker JSON reports into concise JSON or CSV summaries for security analysis
- [Matt-Esch/virtual-dom](https://github.com/Matt-Esch/virtual-dom) - A Virtual DOM and diffing algorithm
- [metaory/glslmine](https://github.com/metaory/glslmine) - Modern GLSL shader gallery with auto-fetch from GLSL Sandbox and Shadertoy, featuring smart filters and minimal interface
...
- [metaory/xvoid](https://github.com/metaory/xvoid) - a minimal, distraction-free new tab cosmic void experience
...
- [metaory/junk-activity-scanner](https://github.com/metaory/junk-activity-scanner) - Automated GitHub repository scanner that evaluates and reports bot-generated junk repositories using multi-language evaluators
...
- [metaory/github-readme-topics-action](https://github.com/metaory/github-readme-topics-action) - GitHub Action to automatically update profile README with categorized repositories by topics, sorted by stars and update time
...
- [metaory/simple-find-file-recursively-up](https://github.com/metaory/simple-find-file-recursively-up) - returns the path at which a provided pattern exists, checking the current directory and any parent directories recursively up
...
- [metaory/proxy-api-transformer](https://github.com/metaory/proxy-api-transformer) - Serverless AWS API Gateway proxy function for transforming, combining, and wrapping existing APIs with JSONPath support
...
- [rcbj/oauth2-oidc-debugger](https://github.com/rcbj/oauth2-oidc-debugger) - An Identity Protocol Debugger
...
- [ameiji/akko-ducky-help](https://github.com/ameiji/akko-ducky-help) - Help for macros settings on Akko/Ducky mechanical keyboards
...
- [curl/quiz](https://github.com/curl/quiz) - Questions about curl for a quiz
...
- [metaory/metaory](https://github.com/metaory/metaory) - 𝙢𝙚𝙩𝙖𝙤𝙧𝙮 gh profile page
...
- [Agent-Lilith/lilith](https://github.com/Agent-Lilith/lilith) - The Agent.
- [Agent-Lilith/lilith-emails](https://github.com/Agent-Lilith/lilith-emails) - Sync, Transform, MCP, Daemon for gmail.
- [melvinquick/psswd_box](https://github.com/melvinquick/psswd_box) - Password generator that never leaves your machine.
...
- [ikramagix/faussaire](https://github.com/ikramagix/faussaire) - A gem to generate ultra-realistic fake data in French and Greek with credible, context-aware, and culturally relevant options.
...
- [metaory/drastic-idle](https://github.com/metaory/drastic-idle) - detect system idleness and start taking phases of drastic measures
...
- [metaory/timelog](https://github.com/metaory/timelog) - Lap-timed terminal notes, line by line
...
- [metaory/xdedup](https://github.com/metaory/xdedup) - find and remove duplicates
- [metaory/nyaa-cli](https://github.com/metaory/nyaa-cli) - CLI for automated anime torrent downloads with stateful episode tracking, quality filters, and uploader selection
- [metaory/theschain](https://github.com/metaory/theschain) - Interactive CLI thesaurus with continuous chain lookups
- [metaory/github-repo-cards](https://github.com/metaory/github-repo-cards) - GitHub Action and CLI for generating beautiful static PNG/SVG cards with dark/light themes, perfect for dashboards and READMEs
- [metaory/zsh-roundy-prompt](https://github.com/metaory/zsh-roundy-prompt) - minimal • roundy prompt for ZSH in 140 lines
- [metaory/deadzone](https://github.com/metaory/deadzone) - incubator for ideas in limbo
- [metaory/svg-timeline-diagram-action](https://github.com/metaory/svg-timeline-diagram-action) - 🚧 Generates and commits SVG Timeline Diagrams from your data
...
- [metaory/bulk-git-tools](https://github.com/metaory/bulk-git-tools) - small collection of git bulk scripts
...
- [metaory/slack-emoji-util](https://github.com/metaory/slack-emoji-util) - bulk Slack emoji, no app no enterprise
...
- [metaory/confsubst](https://github.com/metaory/confsubst) - POSIX-compliant templating CLI with modeline syntax, environment variable substitution, and pre/post hooks for configuration management
...
- [metaory/mxcolr](https://github.com/metaory/mxcolr) - Generate, Preview, Apply beautiful unified human friendly pseudo random color schemes, SYSTEM WIDE!
...
- [JaceThings/Lisse](https://github.com/JaceThings/Lisse) - 
...
- [agardnerIT/collector-game](https://github.com/agardnerIT/collector-game) - https://collectorgame.agardner.net Learn the OpenTelemetry Collector with a game!
...
- [metaory/symbol-logo-maker](https://github.com/metaory/symbol-logo-maker) - [WIP] transforms any symbol, character, or glyph into a logo
...
- [ascorbic/impala](https://github.com/ascorbic/impala) - Very simple React and Preact static site generator
...
- [temporalio/samples-typescript](https://github.com/temporalio/samples-typescript) - Samples for working with the Temporal TypeScript SDK
...
- [WebAssembly/esm-integration](https://github.com/WebAssembly/esm-integration) - ECMAScript module integration

## XC 

- [metaory/xico](https://github.com/metaory/xico) - Minimal CLI utility to generate SVG or PNG images from single Unicode characters or templates, ideal for icon and glyph creation
